...
export default function LoginPage() {
  return (
    <div className="flex min-h-screen min-w-0 flex-col items-center justify-center gap-4 bg-gray-50 p-4 pt-[max(1rem,env(safe-area-inset-top))] pb-[max(1rem,env(safe-area-inset-bottom))] dark:bg-gray-900 sm:p-8">
      <div className="min-w-0 w-full max-w-sm rounded-lg border border-gray-200 bg-white p-6 shadow dark:border-gray-700 dark:bg-gray-800 sm:p-8">
        <h1 className="mb-6 text-center text-xl font-semibold">MentalCarePilot — Anmelden</h1>
